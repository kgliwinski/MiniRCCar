...
const osMessageQueueAttr_t btTx_attributes = {
  .name = "btTx"
};
/* Definitions for btRx */
osMessageQueueId_t btRxHandle;
const osMessageQueueAttr_t btRx_attributes = {
  .name = "btRx"
};
...
void startDisplayTask(void *argument) {
	...
	DigitalPin dispGND1(DISP_G1_GPIO_Port, DISP_G1_Pin);
	DigitalPin dispGND2(DISP_G2_GPIO_Port, DISP_G2_Pin);
	dispGND1.writePin(1);
	dispGND2.writePin(1);
